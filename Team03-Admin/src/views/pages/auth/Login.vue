...
const handleClick = async () => {
    ...
    try {
        ...
        toast.add({ severity: 'success', summary: t('login.success'), life: 900 });
        setTimeout(() => {
            router.push('/');
        }, 700);
    } catch (err) {
        toast.add({ severity: 'error', summary: t('login.error'), life: 15000 });
    }
};
</script>
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4 uppercase">{{ t('login.admin') }}</div>
                        </div>
